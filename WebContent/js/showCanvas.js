...
CanvasState.prototype.loadImages = function (inra, indec) {
    ...
    var objdata = null;
//    alert(centerImg_x+",centerImg_y="+centerImg_y+",imgW="+imgW+",imgH="+imgH+",img="+img+",imgurl="+imgurl+",objdata="+objdata);
...
// old   c.src = "./shownearest.aspx?" + selectedobj;
    c.src = "v1/image/Nearest?" + selectedobj;
//    alert(c.src);
}
