...
<html>
  <head>
    ...
    <script src="js/showCanvas.js" type="text/javascript"></script>
    
    <script src="js/jquery-1.9.0.min.js" type="text/javascript"></script>
    
    <script src="js/STARTBall.js" type="text/javascript"></script>
     <script type="text/javascript">var wsGetJpegurl = "<c:url value='/v1/image/Jpeg?'/>";</script>
    <script type="text/javascript">var wsGetImage64 = "";</script>
    <script type="text/javascript">var release = "DR12";</script>
  	<style type="text/css">
  ...
  <body onload="init();">
 	<p>
    <!-- form 表单 -->
	<form action="<c:url value='/navi.jsp?dec=${param.dec}&ra=${param.ra}'/>" target="main" method="get" name="getjpeg">
		<div id="toc">
        ...
        <table border="0" cellspacing="0" cellpadding="0" >
      	<tr>
           ...
           <td class='s' align="left" onmouseover="this.T_WIDTH='140';return escape('Help on the current tool')"><a target="_blank" href="<c:url value='/naviinfo.jsp'/>">Help&nbsp;|</a></td>
            <td class='s' align="left" ONMOUSEOVER="this.T_WIDTH='140';return escape('View the tool tutorial (Flash)')"><a target="MosaicWindow" href="<c:url value='/navi.swf'/>">Tutorial&nbsp;|</a></td>
		...
		<!-- 	<tr>
	<td><span  onmouseover="this.T_TEMP='3000';this.T_WIDTH='180';return escape('Right ascension as decimal degrees or HH:MM:SS')">name</span></td>
		<td><table cellspacing=0 cellpadding=0><tr><td>
			<INPUT class='in' type='text' size='3' maxlength='20' align='right'
			value=' ' name='objid' id='objid' onChange='setobj();' ></td><td>&nbsp;<span  ONMOUSEOVER="this.T_TEMP='3000';this.T_WIDTH='180';return escape('Right ascension as decimal degrees or HH:MM:SS')"><input type='button' value='Resolve' id='resolve' name='resolve'  >			</span></td></tr></table>
		</td>
</tr> -->
<tr>
	<td><span  onmouseover="this.T_TEMP='3000';this.T_WIDTH='180';return escape('Right ascension as decimal degrees or HH:MM:SS')">ra</span></td>
		<td><table cellspacing=0 cellpadding=0><tr><td>
			<INPUT class='in' type='text' size='3' maxlength='20' align='right'
			value='${param.ra }' name='ra' id='ra' onChange='setra();' ></td><td>&nbsp;<span  onmouseover="this.T_TEMP='3000';this.T_WIDTH='180';return escape('Right ascension as decimal degrees or HH:MM:SS')">deg			</span></td></tr></table>
		</td>
</tr>
<tr>
	<td><span  onmouseover="this.T_TEMP='3000';this.T_WIDTH='180';return escape('Declination as decimal degrees or DD:MM:SS')">dec</span></td>
		<td><table cellspacing=0 cellpadding=0><tr><td>
			<INPUT class='in' type='text' size='3' maxlength='20' align='right'
			value='${param.dec }' name='dec' id='dec' onChange='setdec();' ></td><td>&nbsp;<span  onmouseover="this.T_TEMP='3000';this.T_WIDTH='180';return escape('Declination as decimal degrees or DD:MM:SS')">deg			</span></td></tr></table>
		</td>
</tr>
<tr>
	<td><span  onmouseover="this.T_TEMP='3000';this.T_WIDTH='180';return escape('String of drawing options (checkboxes below)')">opt</span></td>
		<td>
		<table cellspacing=0 cellpadding=0><tr><td>
			<input class='in' type='text' size='3' maxlength='20' align='right'
			value='' name='opt' id='opt' onChange='setoptstr(1);' ></td><td>&nbsp;<span  onmouseover="this.T_TEMP='3000';this.T_WIDTH='180';return escape('String of drawing options (checkboxes below)')">			</span></td></tr></table>
		</td>
</tr>
	...
	<table width="180" cellpadding="0" cellspacing="0" border="1">
		...
		<input type="hidden" value='0.792254' name="scale" id="scale">
		<input type="hidden" value='512'   name="size" id="size">
	</form>
	<!--This Contains Canvas-->
        <div name="toggeleImage" id="mtoggle">  <span class='snavi'><b>  Image Source :  </b></span>
        <input type="radio" name="rad" id="sdss"  value="sdss" checked="checked" onclick="setImageSource(this,'Z')"/><span class='s'>SciDB</span>
        <!-- 
    ...
    <!--Iframe for shownearest-->
	 <iframe id="near" name='near' width ="160px" height="600px" scrolling="no" frameborder="0" src="<c:url value='/v1/image/Nearest?ra=${param.ra eq null?ra:param.ra}&dec=${param.dec eq null?dec:param.dec}'/>"/>
  </body>
</html>
