	    ...
	    <table width="110" cellspacing=0 cellpadding=0>
	     <tr><td><a class="med" target="_top" href='default.aspx' title="Return to the Explore tool default page">Explore Home</a><br/></td></tr>
	        ...
	        <c:if test="${not empty master.id }">
                ...
                <tr><td class="s" align="right"><a href='#' onclick="${master.hrefs.chart}" title="Link to Finding Chart for this object.">Finding chart<img src="../../images/new_window_black.png" alt=" (new window)" /></a></td></tr>
	              ...
	              <td>                     
	                 <table cellpadding=2 cellspacing=2 border=0 width=300>
	                   ...
	                   <tr align='left' >
	                       ...
	                       <td valign='top' class='t'><fmt:formatNumber value="${specCtrl.redshift_z}" pattern="#.###"></fmt:formatNumber></td>
	                   </tr>
	                   <tr align='left' >
	                       <td  valign='top' class='h'><span>Redshift error</span></td>
	                       <td valign='top' class='t'><fmt:formatNumber value="${specCtrl.redshift_err }" pattern="#.#####"></fmt:formatNumber></td>
	                   </tr>
	                   <tr align='left' >
