   ...
   <!-- 
      ...
      <div id="neighbors" class="content">
		<table class="content">
			...
			<%=((ObjectExplorer)request.getAttribute("master")).showHTable(((AllSpec)request.getAttribute("allSpec")).getMapSpec1(), 720,"AllSpectra")%>
			    <h3>Flux-Matched Spectra of this Object</h3>
			
			<%=((ObjectExplorer)request.getAttribute("master")).showHTable(((AllSpec)request.getAttribute("allSpec")).getMapSpec2(), 720,"AllSpectra")%>
			</td></tr>
		</table>
		</div>
   </div>              
