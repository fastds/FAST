...
<%@ page import="org.fastds.model.FitsSpec" %>
      ...
      <div class="content">
        ...
        <table border="0" cellspacing="10" cellpadding="10">
          <tr>
	        ...
	        <td class='l'><a class="content" href="<%=((FitsSpec)request.getAttribute("fitsSpec")).getHrefsSpec()[0]%>">Download</a></td><td>&nbsp;</td>
          </tr>
          <tr>
            <td><b>Download More Spectra:</b></td>
            <td class='l'><b><a class="content" href="${master.globals.dasUrl}basicSpectra">${master.globals.release } Science Archive
